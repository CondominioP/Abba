<?php	
	...
	$sql = "SELECT * FROM `usuario` WHERE Tipo_usuario = 'Morador' ";
	include "conexao.php";		
					...
					<div class="mdl-cell mdl-cell--12-col">
						<table class="mdl-data-table mdl-js-data-table" align="center">
							...
							<?php 
								...
								@$email 			= $banco["Email"];
								@$num_bloco			= $banco["Num_Bloco"];
								@$num_ap			= $banco["Num_Ap"];
								$excluir  = "<a href='excluir1.php?Id=$id&Nome_completo=$nome'><button class='mdl-button mdl-js-button mdl-button--icon mdl-button--colored'><i class='material-icons'>clear</i></button></a>";
								$editar  = "<a href='editar.php?Id=$id'><button class='mdl-button mdl-js-button mdl-button--icon mdl-button--colored'><i class='material-icons'>create</i></button></a>";
