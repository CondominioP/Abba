...
<html lang="pt-br">
	...
	<body>
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			...
			<div class="container through">
				<div class="mdl-grid">
					<div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet">
						<div class="demo-card-square mdl-card mdl-shadow--4dp usuario">
							<div class="mdl-card__title mdl-card--expand">
								<h2 class="mdl-card__title-text">Usuários</h2>
							</div>
							<div class="mdl-card__actions mdl-card--border">
								<a href="../cadastro/cadastro.php" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">
									SAIBA +
								</a>
							</div>
						</div>
					...
					<div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet">
						<div class="demo-card-square mdl-card mdl-shadow--4dp usuario">
							<div class="mdl-card__title mdl-card--expand">
								<h2 class="mdl-card__title-text">Registros</h2>
							</div>
							<div class="mdl-card__actions mdl-card--border">
								<a href="../registros/registros.php" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">
									SAIBA +
								</a>
							</div>
						</div>
					...
					<div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet">
						<div class="demo-card-square mdl-card mdl-shadow--4dp usuario">
							<div class="mdl-card__title mdl-card--expand">
								<h2 class="mdl-card__title-text">Fornecedores</h2>
							</div>
							<div class="mdl-card__actions mdl-card--border">
								<a href ="../fornecedores/cadfornecedores.php" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">
									SAIBA +
								</a>
							</div>
						</div>
