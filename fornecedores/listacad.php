					...
					<div class="mdl-cell mdl-cell--12-col">
						<table class="mdl-data-table mdl-js-data-table" align="center">
							...
							<?php 
								...
								@$id       				= $banco ["Id"];
								@$nome       			= $banco ["Nome_comp"];
								@$tipo       			= $banco ["Tipo_produto"];
								$excluir  = "<a href='excluircad.php?Id=$id&Nome_comp=$nome'><button class='mdl-button mdl-js-button mdl-button--icon mdl-button--colored'><i class='material-icons'>clear</i></button></a>";
								$editar  = "<a href='editarcad.php?Id=$id'><button class='mdl-button mdl-js-button mdl-button--icon mdl-button--colored'><i class='material-icons'>create</i></button></a>";
